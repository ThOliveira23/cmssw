...
zcounting = DQMEDAnalyzer('ZCounting',
				 ...
				 edmPVName       = cms.untracked.string('offlinePrimaryVertices'),
                                 ...
                                 MuonTriggerNames = cms.vstring("HLT_IsoMu24_v*"),  ##MuonTriggerNames = cms.vstring("HLT_IsoMu27_v*"),
                                 MuonTriggerObjectNames = cms.vstring("hltL3crIsoL1sSingleMu22L1f0L2f10QL3f24QL3trkIsoFiltered0p07"),
                                 # before -- MuonTriggerObjectNames = cms.vstring("hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p07"),
                                 ...
                                 PtCutL1  = cms.untracked.double(27.0),    # PtCutL1  = cms.untracked.double(30.0), 
                                 PtCutL2  = cms.untracked.double(27.0),    # PtCutL2  = cms.untracked.double(30.0),
                                 ...
                                 MassBin  = cms.untracked.int32(80),           # MassBin  = cms.untracked.int32(50),
                                 MassMin  = cms.untracked.double(50.0),        # MassMin  = cms.untracked.double(66.0),
                                 MassMax  = cms.untracked.double(130.0),       # MassMax  = cms.untracked.double(116.0),

                                 LumiBin  = cms.untracked.int32(2500),
                                 LumiMin  = cms.untracked.double(0.5),
                                 LumiMax  = cms.untracked.double(2500.5),

                                 PVBin    = cms.untracked.int32(100),       # PVBin    = cms.untracked.int32(60),
                                 PVMin    = cms.untracked.double(0.5),
                                 PVMax    = cms.untracked.double(100.5),   # PVMax    = cms.untracked.double(60.5),
